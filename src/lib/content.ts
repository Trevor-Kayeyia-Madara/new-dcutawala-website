...
export const ministries: Ministry[] = [
  {
    ...
    summary: "The men's ministry of Deliverance Church Utawala.",
  },
  {
    slug: "daughters-of-faith",
    name: "Daughters of Faith",
    subtitle: "Women's Ministry",
    summary: "The women's ministry of Deliverance Church Utawala.",
  },
  {
    slug: "sunday-school",
    name: "Sunday School",
    subtitle: "Children & Young Adults",
    ageGroup: "Young Adults: 13–22 years",
    summary:
      "Children and young adults grow together in faith. Young Adults is the official church terminology for the 13–22 group.",
  },
  {
    slug: "legacy",
    name: "Legacy",
    ...
    summary: "The ministry for young adults aged 23 years and above.",
  },
  {
    slug: "outreach",
    name: "Outreach",
